...
class TestProfile:
    ...
    class TestPause:
        ...
        class TestWhenLastPauseIsNotNone:
            def test_it_returns(self):
                self.subject.last_pause = self.test_start_time
                self.subject.pause()

            def test_it_does_not_update_last_pause(self):
    ...
    class TestResume:
        ...
        class TestWhenLastResumeIsNotNone:
            def test_it_returns(self):
                self.subject.resume()
    ...
    class TestGetActiveMillisSinceStart:
        ...
        class TestWhenPauseAndResumeWereCalled:
            @before
            def before(self):
                self.turn_clock(seconds=9)
                self.subject.pause()
    ...
    class TestGetAverageThreadWeight:
